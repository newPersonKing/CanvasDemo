...
import com.gy.canvasdemo.analyze.ColUtils;
...
import com.gy.canvasdemo.model.ArrayBox;
import com.gy.canvasdemo.view.other.Cons;
import com.gy.canvasdemo.view.other.OnCtrlClickListener;

/* * 说明：数组实现表结构---测试视图*/
public class ArrayView<E> extends View {

    private Point mCoo = new Point(200,200);
    ...
    private void init(){
        ...
        mCooPicture = HelpDraw.getCoo(getContext(),mCoo,true);
...
//                                    contactTest();
    ...
    public void addData(E data) {
        ArrayBox<E> arrayBox = new ArrayBox<E>(0,0);
        arrayBox.data = data;
